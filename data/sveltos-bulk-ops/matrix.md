...
| --- | --- | --- | --- | --- | --- | --- |
| hx-sveltos-env-pilot | pilot | `r1-e199257804ae` | 2 | none |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-staging | staging | `r1-fb24308c6fab` | 2 | none |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-prod-a | prod | `r1-703f3399eaf7` | 2 | none |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-prod-b | prod | `r1-703f3399eaf7` | 2 | none |  | awaiting-live-run (awaiting-gateway-recording) |

## After the fan-out, one pass over every record

| Cluster | Environment | Expected revision | Background replicas | Drift check | Observed | Status |
| --- | --- | --- | --- | --- | --- | --- |
| hx-sveltos-env-pilot | pilot | `r2-d6c85e486a84` | 3 | none |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-staging | staging | `r2-aeb22cf0c2eb` | 3 | none |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-prod-a | prod | `r2-246a9ab834a5` | 3 | none |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-prod-b | prod | `r2-246a9ab834a5` | 3 | none |  | awaiting-live-run (awaiting-gateway-recording) |

## Zero-drift audit; injected drift repaired on every cluster

| Cluster | Environment | Expected revision | Background replicas | Drift check | Observed | Status |
| --- | --- | --- | --- | --- | --- | --- |
| hx-sveltos-env-pilot | pilot | `r2-d6c85e486a84` | 3 | injected-and-restored |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-staging | staging | `r2-aeb22cf0c2eb` | 3 | injected-and-restored |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-prod-a | prod | `r2-246a9ab834a5` | 3 | injected-and-restored |  | awaiting-live-run (awaiting-gateway-recording) |
| hx-sveltos-env-prod-b | prod | `r2-246a9ab834a5` | 3 | injected-and-restored |  | awaiting-live-run (awaiting-gateway-recording) |
